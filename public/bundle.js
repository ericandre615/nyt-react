...
/***/ function(module, exports, __webpack_require__) {
	...
	var options = {
	  ...
	  viewResolver: function(viewName) {
	    return __webpack_require__(226)("./" + viewName);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsAppJsx = __webpack_require__(200);

	var _viewsAppJsx2 = _interopRequireDefault(_viewsAppJsx);

	var _viewsRecentJsx = __webpack_require__(204);

	var _viewsRecentJsx2 = _interopRequireDefault(_viewsRecentJsx);

	var _viewsAverageJsx = __webpack_require__(221);

	var _viewsAverageJsx2 = _interopRequireDefault(_viewsAverageJsx);

	var _viewsResultsJsx = __webpack_require__(222);

	var _viewsResultsJsx2 = _interopRequireDefault(_viewsResultsJsx);

	var _views404Jsx = __webpack_require__(223);

	var _views404Jsx2 = _interopRequireDefault(_views404Jsx);
	...
	exports['default'] = _react2['default'].createElement(
	  ...
	  _react2['default'].createElement(_reactRouter.DefaultRoute, { handler: _viewsRecentJsx2['default'] })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _layoutJsx = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsHeaderJsx = __webpack_require__(202);
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('link', { rel: 'stylesheet', href: '//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css' })
	      ),
	      _react2['default'].createElement(
	        'body',
	        { id: 'app' },
	        ...
	        _react2['default'].createElement(
	          'main',
	          { role: 'main', className: 'container', style: { 'paddingTop': '8em' } },
	          this.props.children
	        )
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchJsx = __webpack_require__(203);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      'header',
	      { role: 'banner', style: this.styles, className: 'navbar navbar-fixed-top' },
	      _react2['default'].createElement(
	        'div',
	        { className: 'container', style: this.containerStyles },
	        _react2['default'].createElement(
	          'h1',
	          { className: 'text-left', style: this.h1Styles },
	          'NYT Article API'
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsHelpers = __webpack_require__(205);

	var _articlesJsx = __webpack_require__(220);

	var _articlesJsx2 = _interopRequireDefault(_articlesJsx);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    (0, _utilsHelpers.getRecentArticles)().then(function (data) {
	      _this.setState({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(_articlesJsx2['default'], { recentArticles: this.state.recentArticles })
	    );
	  }
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	let axios = __webpack_require__(206);
	let config = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  propTypes: {
	    recentArticles: _react2['default'].PropTypes.array.isRequired
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  getAverage: function getAverage(total, occurrences) {
	    return Math.floor(total / occurrences);
	  },

	  getInitialState: function getInitialState() {
	    return {
	      days: [{ 'day': 'monday', 'occurrences': 52, 'average': 0 }, { 'day': 'tuesday', 'occurrences': 52, 'average': 0 }, { 'day': 'wednesday', 'occurrences': 53, 'average': 0 }, { 'day': 'thursday', 'occurrences': 52, 'average': 0 }, { 'day': 'friday', 'occurrences': 52, 'average': 0 }, { 'day': 'saturday', 'occurrences': 52, 'average': 0 }, { 'day': 'sunday', 'occurrences': 52, 'average': 0 }]
	    };
	  },
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    days.forEach(function (day) {
	      (0, _utilsHelpers.getArticlesByDays)(day.day).then(function (data) {
	        var total = data.data.response.meta.hits;
	        var average = _this.getAverage(total, day.occurrences);
	  ...
	  render: function render() {
	    ...
	    var averages = this.state.days.map(function (day, index) {
	      return _react2['default'].createElement(
	        'td',
	        { key: index },
	        day.average
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'h2',
	        null,
	        'Average articles per day for 2014'
	      ),
	      _react2['default'].createElement(
	        'table',
	        { className: 'table' },
